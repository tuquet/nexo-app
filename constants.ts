...
export const PREDEFINED_GENRES = [
  ...
  'Chính kịch', 'Gia đình', 'Giả tưởng', 'Lịch sử', 'Kinh dị', 'Nhạc kịch',
  'Huyền bí', 'Lãng mạn', 'Khoa học viễn tưởng', 'Giật gân', 'Chiến tranh', 'Viễn Tây'
];
...
export const DEFAULT_IMAGE_NEGATIVE_PROMPT = 'chữ ký, văn bản, chữ viết, watermark, logo, hai hình ảnh, màn hình chia đôi, cắt dán, diptych, triptych, không mạch lạc, biến dạng, xấu xí, chất lượng thấp, mờ, khung hình, viền';